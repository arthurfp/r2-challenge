...
// Source: internal/payment/adapters/db/interface.go
...
func (m *MockRepository) Save(ctx context.Context, payment domain.Payment) (domain.Payment, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Save(ctx, payment interface{}) *gomock.Call {
